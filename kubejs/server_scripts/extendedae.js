ServerEvents.recipes(nadien => {
    ...
    cell('kubejs:lava_cell', 'reliquary:infernal_chalice', 'minecraft:lava_bucket', 'minecraft:lava_bucket', 'megacells:cell_component_256m')
    ...
    cell('kubejs:obsidian_cell', 'allthecompressed:obsidian_2x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
